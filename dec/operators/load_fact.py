...
class LoadFactOperator(BaseOperator):
    ...
    @apply_defaults
    def __init__(self, db_conn_id="", table="", raw_table="", dim_player="", dim_historical="", dim_all_star="",
        ...
        self.dim_historical = dim_historical
        self.dim_all_star = dim_all_star
        self.clean = clean
        self.skip = skip
    ...
    def execute(self, context):
        ...
        if not self.skip:
            ...
            db.run(self.insert_query(self.table, self.raw_table, self.dim_player,
                                     self.dim_all_star, self.dim_historical))
